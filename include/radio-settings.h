...
enum ofono_radio_access_mode {
	OFONO_RADIO_ACCESS_MODE_ANY = -2,
	OFONO_RADIO_ACCESS_MODE_LTE = -1,
	OFONO_RADIO_ACCESS_MODE_UMTS = 0,
	OFONO_RADIO_ACCESS_MODE_GSM = 1,
	OFONO_RADIO_ACCESS_MODE_WCDMA_ONLY = 2,
	OFONO_RADIO_ACCESS_MODE_LTE_GSM_WCDMA = 9,
	OFONO_RADIO_ACCESS_MODE_LTE_ONLY = 11,
	OFONO_RADIO_ACCESS_MODE_LTE_WCDMA = 12,
};
